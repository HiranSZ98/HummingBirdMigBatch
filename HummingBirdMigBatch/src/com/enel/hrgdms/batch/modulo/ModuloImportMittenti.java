...
public class ModuloImportMittenti implements Modulo {

	private static Logger log = Logger.getLogger(ModuloImportMittenti.class);
	public static final String module_name = "ModuloImportMittenti";
	private Reporter reporter;
	private int num_rows = 0;
	private String csvPath = "lotti/ElencoDestinatariMittenti.csv";
